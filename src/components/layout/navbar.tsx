  ...
  const navLinks = [
    {
      ...
      href: '/destinations',
      children: [
        { label: 'East Java', href: '/destinations?region=east-java' },
        { label: 'Bali', href: '/destinations?region=bali' },
    ...
    },
    {
      ...
      href: '/packages',
      children: [
        { label: 'Shared tours', href: '/packages?type=shared' },
        { label: 'Private tours', href: '/packages?type=private' },

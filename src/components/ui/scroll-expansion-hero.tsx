        ...
        <div className="relative w-full flex flex-col items-center min-h-[100dvh]">
          ...
          >
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-b from-volcanic/40 via-transparent to-volcanic" />
          </motion.div>
            ...
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              ...
              >
                ...
                <div className="flex flex-col items-center text-center relative z-10 mt-4 transition-none">
                  {date && (
                    <p
                      className="text-xl text-cream-dark font-display tracking-wider"
                  ...
                  {scrollToExpand && (
                    <p
                      className="text-cream-muted text-sm font-medium mt-2 tracking-widest uppercase"
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
              ...
              >
                <motion.h1
                  className="font-display text-display-2xl text-cream transition-none leading-none"
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h1>
                <motion.h1
                  className="font-display text-display-2xl text-gradient-sunset transition-none leading-none"
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h1>
